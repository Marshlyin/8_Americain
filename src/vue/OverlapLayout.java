 ...
 *  over the components.
 *  
 *  Website source : https://tips4java.wordpress.com/2009/07/26/overlap-layout/
 *  
 *  @author Rob Camick
 */
public class OverlapLayout implements LayoutManager2, java.io.Serializable
{
	private static final long serialVersionUID = -3124847104189069592L;
	 ...
	 *  @param overlapAbove 
	 *  					when true components are painted above the previous
